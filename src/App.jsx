...
const ChattyData = { // Defined ChattyData
...
class App extends Component { // Constructor stage for the this.state
  ...
  componentDidMount() { // Once component connects and mount..
